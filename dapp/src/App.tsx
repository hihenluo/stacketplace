      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        {!stxAddress ? (
          <div className="py-32 text-center animate-pulse">
            ...
            <p className="text-gray-500 uppercase tracking-[0.2em] text-sm">Please unlock your wallet to enter the dollhouse</p>
          </div>
        ) : (
          <div className="transition-all duration-700">
            ...
            {activeTab === 'market' && (
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {/* Logic to map active listings from API would go here */}
                <MarketCard listingId={0} tokenId={10} price={25} />
                <MarketCard listingId={1} tokenId={15} price={40} />
              </div>
            )}
